<template>
    <div class="columns is-centered is-vcentered has-height-100-percent is-paddingless ok-has-background-primary-highlight is-marginless">
        <div class="column is-narrow">
            <div class="card is-relative has-overflow-hidden ok-has-background-primary ok-reset-password-page-card">
                ...
                <div class="card-content">
                    <ok-reset-password-form></ok-reset-password-form>
                </div>
...
<script lang="ts">
    ...
    import OkResetPasswordForm from '~/components/forms/OkResetPasswordForm.vue';

    @Component({
        name: "OkResetPasswordPage",
        components: {OkResetPasswordForm, OkRequestPasswordResetForm, OkLogo},
    })
    export default class OkResetPasswordPage extends Vue {
